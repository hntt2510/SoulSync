...
const MESSAGE_STYLE =
  'pointer-events-none max-w-[200px] rounded-2xl border border-white/18 bg-white/[0.12] px-3.5 py-2.5 text-left text-xs text-white/92 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-md sm:max-w-[220px] sm:px-4 sm:text-sm'
